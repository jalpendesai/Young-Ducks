...
{
	PlayerController movement;	//Reference to the PlayerMovement script component
	Rigidbody2D rigidBody;		//Reference to the Rigidbody2D component
	InputManager input;			//Reference to the PlayerInput script component
	...
	void Start()
	{
		...
		input		= parent.GetComponent<InputManager>();
